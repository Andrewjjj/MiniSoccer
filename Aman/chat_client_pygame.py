...
qqq=0
def get_input():
    global surface, screen_size, message, x1,y1, qqq
    ...
    elif pressed[pygame.K_DOWN]: y1 += 3
    elif pressed[pygame.K_LEFT]: x1 -= 3
    elif pressed[pygame.K_RIGHT]: x1 += 3
    ...
    to_send.append(["add",""+name+": "+str(x1)+" "+str(y1)])
    # to_send.append(["add",str(qqq)])
    # qqq+=1
    # time.sleep(0.06)
    # else:
        # to_send=None
